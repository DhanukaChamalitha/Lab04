package com.example.newlabexam04.adapter
...
import com.example.newlabexam04.databinding.TaskLayoutBinding
import com.example.newlabexam04.fragment.HomeFragmentDirections
...
class TaskAdapter: RecyclerView.Adapter<TaskAdapter.TaskViewHolder>(){
    ...
    override fun onBindViewHolder(holder: TaskViewHolder, position: Int) {
        ...
        holder.itemBinding.taskTitle.text = currentTask.taskDesc

        holder.itemView.setOnClickListener{
            val direction = HomeFragmentDirections.actionHomeFragmentToEditTaskFragment(currentTask.toString())
